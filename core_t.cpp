	...
	:ID(ID), QMainWindow(parent), top(top)
{
	...
	*/
	...
	ui.kechengzongxueshi->setValidator(new QRegExpValidator(QRegExp("^[0-9]*$")));
	ui.kechengxuefen->setValidator(new QRegExpValidator(QRegExp("^[0-9]*$")));
	ui.zjbh->setValidator(new QRegExpValidator(QRegExp("^[0-9]*$")));
	ui.zjzxs->setValidator(new QRegExpValidator(QRegExp("^[0-9]*$")));
	ui.zjxf->setValidator(new QRegExpValidator(QRegExp("^[0-9]*$")));
	ui.kechengbianhao_2->setValidator(new QRegExpValidator(QRegExp("^[0-9]*$")));
	ui.jiaoshibianhao->setValidator(new QRegExpValidator(QRegExp("^[0-9]*$")));
	ui.course_id->setValidator(new QRegExpValidator(QRegExp("^[0-9]*$")));
	ui.stu_id->setValidator(new QRegExpValidator(QRegExp("^[0-9]*$")));
	ui.add_score->setValidator(new QRegExpValidator(QRegExp("^[0-9]*$")));
	ui.xhcx->setValidator(new QRegExpValidator(QRegExp("^[0-9]*$")));
	ui.gaixh->setValidator(new QRegExpValidator(QRegExp("^[0-9]*$")));
	ui.gaimm->setValidator(new QRegExpValidator(QRegExp("[A-Za-z0-9!@#$%^&*()_+{}|:\"<>?]+$")));
	ui.subid->setValidator(new QRegExpValidator(QRegExp("^[0-9]*$")));
	ui.sub_id->setValidator(new QRegExpValidator(QRegExp("^[0-9]*$")));
	ui.score->setValidator(new QRegExpValidator(QRegExp("^[0-9]*$")));
	ui.qendh->setValidator(new QRegExpValidator(QRegExp("^[0-9]*$")));
	ui.qendm->setValidator(new QRegExpValidator(QRegExp("^[0-9]*$")));
	ui.qsearch->setValidator(new QRegExpValidator(QRegExp("^[0-9]*$")));
	ui.qstarth->setValidator(new QRegExpValidator(QRegExp("^[0-9]*$")));
	ui.qstartm->setValidator(new QRegExpValidator(QRegExp("^[0-9]*$")));
	ui.q_subid->setValidator(new QRegExpValidator(QRegExp("^[0-9]*$")));
	ui.subjid->setValidator(new QRegExpValidator(QRegExp("^[0-9]*$")));
...
void  core_t::correct(){
	if (!(ui.score->text().isEmpty())&&searchnum!=-1) {
		int i;
